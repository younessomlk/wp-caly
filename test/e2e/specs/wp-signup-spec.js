...
import JetpackAddNewSitePage from '../lib/pages/signup/jetpack-add-new-site-page.js';

import AboutPage from '../lib/pages/signup/about-page.js';
import CustomerHomePage from '../lib/pages/customer-home-page.js';
import DomainFirstPage from '../lib/pages/signup/domain-first-page.js';
import ReaderLandingPage from '../lib/pages/signup/reader-landing-page.js';
...
import ImportFromURLPage from '../lib/pages/signup/import-from-url-page.js';
import SiteTypePage from '../lib/pages/signup/site-type-page.js';
import SiteTitlePage from '../lib/pages/signup/site-title-page.js';
import LoginPage from '../lib/pages/login-page.js';
import MagicLoginPage from '../lib/pages/magic-login-page.js';
import ReaderPage from '../lib/pages/reader-page.js';
import DomainOnlySettingsPage from '../lib/pages/domain-only-settings-page.js';
import DomainDetailsPage from '../lib/pages/domain-details-page.js';
import CancelPurchasePage from '../lib/pages/cancel-purchase-page.js';
import CancelDomainPage from '../lib/pages/cancel-domain-page.js';
import ThemesPage from '../lib/pages/themes-page.js';
import ThemeDetailPage from '../lib/pages/theme-detail-page.js';
import ImportPage from '../lib/pages/import-page.js';
...
import NewUserRegistrationUnavailableComponent from '../lib/components/new-user-domain-registration-unavailable-component.js';
import DeleteAccountFlow from '../lib/flows/delete-account-flow.js';
import DeletePlanFlow from '../lib/flows/delete-plan-flow.js';
import SignUpStep from '../lib/flows/sign-up-step.js';
import LaunchSiteFlow from '../lib/flows/launch-site-flow.js';
import ActivateAccountFlow from '../lib/flows/activate-account-flow.js';

import * as sharedSteps from '../lib/shared-steps/wp-signup-spec.js';
import AccountSettingsPage from '../lib/pages/account/account-settings-page.js';
