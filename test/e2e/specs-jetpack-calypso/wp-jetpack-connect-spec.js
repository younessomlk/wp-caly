...
import AddNewSitePage from '../lib/pages/add-new-site-page.js';
...
import WPAdminNewUserPage from '../lib/pages/wp-admin/wp-admin-new-user-page.js';
...
import JetpackConnectPage from '../lib/pages/jetpack/jetpack-connect-page.js';
import JetpackConnectAddCredentialsPage from '../lib/pages/jetpack/jetpack-connect-add-credentials-page.js';
import PlansPage from '../lib/pages/plans-page.js';
import LoginPage from '../lib/pages/login-page.js';
import JetpackComPage from '../lib/pages/external/jetpackcom-page.js';
import JetpackComFeaturesDesignPage from '../lib/pages/external/jetpackcom-features-design-page.js';
import WooWizardSetupPage from '../lib/pages/woocommerce/woo-wizard-setup-page.js';
import WooWizardJetpackPage from '../lib/pages/woocommerce/woo-wizard-jetpack-page.js';

import * as driverManager from '../lib/driver-manager.js';
import * as driverHelper from '../lib/driver-helper.js';
import * as dataHelper from '../lib/data-helper.js';
import JetpackComPricingPage from '../lib/pages/external/jetpackcom-pricing-page.js';
import SecurePaymentComponent from '../lib/components/secure-payment-component.js';
import WPHomePage from '../lib/pages/wp-home-page.js';
import ThankYouModalComponent from '../lib/components/thank-you-modal-component.js';
import MyPlanPage from '../lib/pages/my-plan-page.js';
import WooWizardWelcomePage from '../lib/pages/woocommerce/woo-wizard-welcome-page.js';
import WooWizardIndustryPage from '../lib/pages/woocommerce/woo-wizard-industry-page.js';
import WooWizardProductPage from '../lib/pages/woocommerce/woo-wizard-product-page.js';
import WooWizardBusinessDetailsPage from '../lib/pages/woocommerce/woo-wizard-business-details-page.js';
import WooWizardThemePage from '../lib/pages/woocommerce/woo-wizard-theme-page.js';
import WPAdminInPlaceApprovePage from '../lib/pages/wp-admin/wp-admin-in-place-approve-page.js';
import WPAdminInPlacePlansPage from '../lib/pages/wp-admin/wp-admin-in-place-plans-page.js';
